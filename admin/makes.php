...
<?php $data = $content->getMakes(false);?>
...
<div class="wojo tertiary segment">
  <div class="header clearfix"><span><?php echo Lang::$word->MAKE_TITLE;?></span> <a data-set='{"title": "<?php echo Lang::$word->MAKE_ADDNEW;?>", "option": "addNewMake", "label": "<?php echo Lang::$word->MAKE_ADD;?>", "redirect": "<?php echo Url::adminUrl("makes");?>"}' id="addNew" class="wojo large top right detached action label" data-content="<?php echo Lang::$word->MAKE_ADD;?>"><i class="icon plus"></i></a> </div>
  <?php if(!$data):?>
  ...
  <ul class="wojo block grid divided large-4 medium-2 small-1" id="editable">
    ...
    <li class="item"> <a class="delete wojo top right corner label" data-set='{"title": "<?php echo Lang::$word->MAKE_DEL;?>", "parent": "li", "option": "deleteMake", "id": <?php echo $row->id;?>, "name": "<?php echo $row->name;?>"}'><i class="icon negative delete link"></i></a>
