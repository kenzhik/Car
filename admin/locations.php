...
<div class="wojo form segment">
  ...
  <form method="post" id="wojo_form" name="wojo_form">
    ...
    <div class="two fields">
      ...
      <div class="field">
        <label><?php echo Lang::$word->CF_LOGO;?></label>
        <div class="wojo circular primary small image"><img src="<?php echo UPLOADURL;?>showrooms/<?php echo ($row->logo) ? $row->logo : "blank.png";?>" alt=""></div>
      </div>
    </div>
    ...
    <div class="wojo divided card">
      ...
      <div class="actions">
        <div class="item">
          ...
          <div class="data"><a href="<?php echo Url::adminUrl("locations", "edit", false,"?id=" . $row->id);?>"><i class="rounded inverted positive icon pencil link"></i></a> <a class="delete" data-set='{"title": "<?php echo Lang::$word->LOC_DELOC;?>", "parent": ".row", "option": "deleteLocation", "id": <?php echo $row->id;?>, "name": "<?php echo $row->name;?>"}'><i class="rounded inverted negative icon trash alt link"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
