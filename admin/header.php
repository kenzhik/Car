        ...
        <ul>
          ...
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('myaccount', 'accstats', 'roles', 'staff', 'groups', 'members'))) echo ' active';?>"><span><?php echo Lang::$word->AMD_ACC;?></span></a>
            <ul>
              ...
              <?php endif;?>
              <?php if (Users::checkAcl("owner", "admin", "editor")):?>
          ...
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('items', 'makes', 'models', 'features', 'categories', 'conditions', 'fuel', 'transmissions'))) echo ' active';?>"><span><?php echo Lang::$word->AMD_ITEMS;?></span></a>
            <ul>
          ...
          <li class="normal"><a class="submenu<?php if (Url::isPartSet(1, array('configuration', 'countries', 'bans', 'gateways', 'packages', 'locations'))) echo ' active';?>"><span><?php echo Lang::$word->AMD_CONF;?></span></a>
            <ul>
              ...
              <li><a <?php if (in_array("locations", $core->_url)) echo ' class="active"';?> href="<?php echo Url::adminUrl("locations");?>"><?php echo Lang::$word->LOC_TITLE;?></a></li>
