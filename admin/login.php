...
<div id="container">
  <header>
    <div class="avatar"><img src="../uploads/avatars/<?php echo $data['avatar'] ? $data['avatar'] : "blank.png";?>" alt=""></div>
    <p><?php echo Utility::sayHello();?> <?php echo $data['name'] ? $data['name'] : Lang::$word->GUEST;?>!</p>
  </header>
