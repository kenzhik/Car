...
<?php $data = $content->getModels();?>
<?php $makedata = $content->getMakes(false);?>
  ...
  <table class="wojo grid table" id="editable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a class="delete" data-set='{"title": "<?php echo Lang::$word->MODL_DEL;?>", "parent": "tr", "option": "deleteModel", "id": <?php echo $row->mdid;?>, "name": "<?php echo $row->mdname;?>"}'><i class="rounded outline icon negative trash link"></i></a></td>
      </tr>
      <?php endforeach;?>
      <?php unset($row);?>
      <?php endif;?>
